...
func (b providerTaxing2011) FactorSolidary(period types.IPeriod) Decimal {
	return NewFromFloat(TAXING_FACTOR_SOLIDARY)
}

func (b providerTaxing2011) FactorTaxRate2(period types.IPeriod) Decimal {
...
func (b providerTaxing2011) MarginIncomeOfSolidary(period types.IPeriod) int32 {
	return TAXING_MARGIN_INCOME_OF_SOLIDARY
}

func (b providerTaxing2011) MarginIncomeOfTaxRate2(period types.IPeriod) int32 {
