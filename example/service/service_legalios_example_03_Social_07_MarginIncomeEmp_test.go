...
func TestSocialMarginIncomeEmp(t *testing.T) {
	...
	logTestIntExamples(t, "03_Social_07_MarginIncomeEmp.txt", testExamples)
	...
	for _, tx := range testExamples {
		for _, tt := range tx.tests {
			t.Run(tt.testName, func(t *testing.T) {
				...
				var resultValue = bundle.GetSocialProps().MarginIncomeEmp()
