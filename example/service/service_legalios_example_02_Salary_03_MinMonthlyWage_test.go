...
func TestSalaryMinMonthlyWage(t *testing.T) {
	testExamples := []testIntScenario{
		{"2010",
			[]testIntParams{
				{"2010-1", 2010, 1, 2010, 1, 8000},
				{"2010-2", 2010, 2, 2010, 2, 8000},
				{"2010-3", 2010, 3, 2010, 3, 8000},
				{"2010-4", 2010, 4, 2010, 4, 8000},
				{"2010-5", 2010, 5, 2010, 5, 8000},
				{"2010-6", 2010, 6, 2010, 6, 8000},
				{"2010-7", 2010, 7, 2010, 7, 8000},
				{"2010-8", 2010, 8, 2010, 8, 8000},
				{"2010-9", 2010, 9, 2010, 9, 8000},
				{"2010-10", 2010, 10, 2010, 10, 8000},
				{"2010-11", 2010, 11, 2010, 11, 8000},
				{"2010-12", 2010, 12, 2010, 12, 8000},
			},
		},
		{"2011",
			[]testIntParams{
		...
		{"2022",
			[]testIntParams{
				{"2022-1", 2022, 1, 2022, 1, 16200},
				{"2022-2", 2022, 2, 2022, 2, 16200},
				{"2022-3", 2022, 3, 2022, 3, 16200},
				{"2022-4", 2022, 4, 2022, 4, 16200},
				{"2022-5", 2022, 5, 2022, 5, 16200},
				{"2022-6", 2022, 6, 2022, 6, 16200},
				{"2022-7", 2022, 7, 2022, 7, 16200},
				{"2022-8", 2022, 8, 2022, 8, 16200},
				{"2022-9", 2022, 9, 2022, 9, 16200},
				{"2022-10", 2022, 10, 2022, 10, 16200},
				{"2022-11", 2022, 11, 2022, 11, 16200},
				{"2022-12", 2022, 12, 2022, 12, 16200},
			},
		},
	}

	// 02_Salary_03_MinMonthlyWage
	logTestIntExamples(t, "02_Salary_03_MinMonthlyWage.txt", testExamples)
	...
	for _, tx := range testExamples {
		for _, tt := range tx.tests {
			t.Run(tt.testName, func(t *testing.T) {
				...
				var resultValue = bundle.GetSalaryProps().MinMonthlyWage()
