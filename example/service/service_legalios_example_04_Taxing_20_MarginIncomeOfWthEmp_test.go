...
func TestTaxingMarginIncomeOfWthEmp(t *testing.T) {
	testExamples := []testIntScenario{
		...
		{"2019",
			[]testIntParams{
				{"2019-1", 2019, 1, 2019, 1, 2500},
				{"2019-2", 2019, 2, 2019, 2, 2500},
				{"2019-3", 2019, 3, 2019, 3, 2500},
				{"2019-4", 2019, 4, 2019, 4, 2500},
	...
	logTestIntExamples(t, "04_Taxing_20_MarginIncomeOfWthEmp.txt", testExamples)
	...
	for _, tx := range testExamples {
		for _, tt := range tx.tests {
			t.Run(tt.testName, func(t *testing.T) {
				...
				var resultValue = bundle.GetTaxingProps().MarginIncomeOfWthEmp()
