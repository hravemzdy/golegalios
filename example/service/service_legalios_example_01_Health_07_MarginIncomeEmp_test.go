...
func TestHealthMarginIncomeEmp(t *testing.T) {
	...
	logTestIntExamples(t, "01_Health_07_MarginIncomeEmp.txt", testExamples)
	...
	for _, tx := range testExamples {
		for _, tt := range tx.tests {
			t.Run(tt.testName, func(t *testing.T) {
				...
				var resultValue = bundle.GetHealthProps().MarginIncomeEmp()
