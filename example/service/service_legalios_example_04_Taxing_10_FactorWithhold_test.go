...
func TestTaxingFactorWithhold(t *testing.T) {
	testExamples := []testDecScenario{
		{"2010",
			[]testDecParams{
				{"2010-1", 2010, 1, 2010, 1, 15.0},
				{"2010-2", 2010, 2, 2010, 2, 15.0},
				{"2010-3", 2010, 3, 2010, 3, 15.0},
				{"2010-4", 2010, 4, 2010, 4, 15.0},
				{"2010-5", 2010, 5, 2010, 5, 15.0},
				{"2010-6", 2010, 6, 2010, 6, 15.0},
				{"2010-7", 2010, 7, 2010, 7, 15.0},
				{"2010-8", 2010, 8, 2010, 8, 15.0},
				{"2010-9", 2010, 9, 2010, 9, 15.0},
				{"2010-10", 2010, 10, 2010, 10, 15.0},
				{"2010-11", 2010, 11, 2010, 11, 15.0},
				{"2010-12", 2010, 12, 2010, 12, 15.0},
			},
		},
		{"2011",
			[]testDecParams{
	...
	logTestDecExamples(t, "04_Taxing_10_FactorWithhold.txt", testExamples)
	...
	for _, tx := range testExamples {
		for _, tt := range tx.tests {
			t.Run(tt.testName, func(t *testing.T) {
				...
				resultValue := bundle.GetTaxingProps().FactorWithhold()
