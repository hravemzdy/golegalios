...
func TestSocialMaxAnnualsBasis(t *testing.T) {
	...
	logTestIntExamples(t, "03_Social_01_MaxAnnualsBasis.txt", testExamples)
	...
	for _, tx := range testExamples {
		for _, tt := range tx.tests {
			t.Run(tt.testName, func(t *testing.T) {
				...
				var resultValue = bundle.GetSocialProps().MaxAnnualsBasis()
